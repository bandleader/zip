        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    filename = path__namespace.resolve(__dirname, "../default-files", zipDefaultFilePath);
                    if (!!fs__namespace.existsSync(filename)) return [3 /*break*/, 3];
                    console.error("zipFsProvider could not find DefaultFile", id, "at path", filename, "called from", from || "?");
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, fs__namespace.promises.readFile(filename, { encoding: "UTF8" })];
                case 4:
                    ret = _a.sent();
                    _a.label = 5;
                ...
                case 6:
                    ...
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, fs__namespace.promises.readFile(file.localPath, { encoding: "UTF8" })];
                case 8:
                    ret = _a.sent();
                    _a.label = 9;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        for (_i = 0, staticFiles_1 = staticFiles; _i < staticFiles_1.length; _i++) {
                            ...
                            if (!fs__namespace.existsSync(dirOfOutputPath))
                                fs__namespace.mkdirSync(dirOfOutputPath, { recursive: true });
                            fs__namespace.copyFileSync(f.localPath, outputPath);
                        }
                        fs__namespace.writeFileSync(outputDir + "/index.html", this.getFrontendIndex());
                        _b = (_a = fs__namespace).writeFileSync;
