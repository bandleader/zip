        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!!fs__namespace.existsSync(filename)) return [3 /*break*/, 2];
                    console.error("zipFsProvider could not find DefaultFile", id, "at path", filename, "called from", from || "?");
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, fs__namespace.promises.readFile(filename, { encoding: "UTF8" })];
                case 3:
                    ret = _a.sent();
                    _a.label = 4;
                ...
                case 5:
                    ...
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, fs__namespace.promises.readFile(file.localPath, { encoding: "UTF8" })];
                case 7:
                    ret = _a.sent();
                    _a.label = 8;
